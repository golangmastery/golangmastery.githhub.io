        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center space-x-2 mb-6">
              ...
              <div className="font-bold text-xl text-white">GolangMastery</div>
            </div>
            <p className="text-gray-400 mb-6">
              Learn Golang with hands-on labs and projects. Master Go programming with our structured learning path.
            </p>
            <div className="flex space-x-4">
              <a href="https://github.com/golangmastery" className="text-gray-400 hover:text-white transition-colors" aria-label="GitHub">
              ...
              <a href="https://twitter.com/golangmastery" className="text-gray-400 hover:text-white transition-colors" aria-label="Twitter">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                </svg>
              </a>
              <a href="https://discord.gg/golangmastery" className="text-gray-400 hover:text-white transition-colors" aria-label="Discord">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Subscribe to our newsletter to get the latest updates on Golang tutorials, projects, and tips.</p>
